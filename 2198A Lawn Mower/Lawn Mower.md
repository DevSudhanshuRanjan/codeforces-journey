...
The only line of each test case contains two integers n and w (1≤n≤109, 1≤w≤109) — the number of boards in the fence and the width of the lawnmower in meters, respectively.
