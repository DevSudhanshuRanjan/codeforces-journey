...
The first line of each test case contains three integers n, x, and y (2≤n≤2⋅105, 1≤y≤x≤109) — the number of banks, the transfer amount, and the credited amount.

The second line of each test case contains n integers a1,a2,…,an (1≤ai≤109) — the initial amount of rubles in each bank.
...
(10,9,8,7)
−→−1→4(5,9,8,11)−→−1→4(0,9,8,15)
−→−4→3(0,9,12,10)−→−4→3(0,9,16,5)−→−4→3(0,9,20,0)
−→−3→2(0,13,15,0)−→−3→2(0,17,10,0)−→−3→2(0,21,5,0)−→−3→2(0,25,0,0).
